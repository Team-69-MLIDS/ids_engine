...
def train_model(run_tag: str, 
    ...
    detection_model_name = 'treebased'
...
# In[37]:
    ...
    record_stats('DecisionTreeClassifier', classification_report(y_true,y_predict, output_dict=True))
...
# In[48]:
    ...
    plt.xlabel("y_pred")
    plt.ylabel("y_true")
    confusion_matrices.update({'treebased': fig_to_base64(plt)})
    record_stats('treebased', classification_report(y_true,y_predict, output_dict=True))
