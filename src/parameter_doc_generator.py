from docstring_parser import parse_from_object, parse, DocstringStyle
...
with open('catboost_hyperparams.csv', mode='w+', newline='') as csvfile: 
    csv_writer = csv.writer(csvfile)
    csv_writer.writerow(['lib', 'arg_name', 'default', 'description'])
    for p in parse_from_object(CatBoostClassifier).params:
        csv_writer.writerow(('catboost', p.arg_name, p.default or "No default", p.description or "No description"))
...
"""
with open('lightgbm.csv', mode='w+', newline='') as csvfile: 
    csv_writer = csv.writer(csvfile)
    csv_writer.writerow(['lib', 'arg_name', 'default', 'description'])
    for p in parse(lightgbm_docs).params:
        csv_writer.writerow(('lightgbm', p.arg_name, p.default or "No default", p.description or "No description"))
